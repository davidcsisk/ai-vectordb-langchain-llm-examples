...
<script crossorigin="anonymous" defer="defer" type="application/javascript" src="https://github.githubassets.com/assets/react-code-view-fdba42ad3995.js"></script>
  ...
  <title>GPT_examples/example_loading-data-from-mssql-into-solr-vector-embeddings.py at main · davidcsisk/GPT_examples</title>
  ...
  <meta name="request-id" content="EC81:9D70:5EBC71:89015B:653836FB" data-turbo-transient="true" /><meta name="html-safe-nonce" content="f315f19a402971cae5402a560cc8b47f2a1dcd7580a599d5fd5f8ef2fdae3e9f" data-turbo-transient="true" /><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHBzOi8vZ2l0aHViLmNvbS9kYXZpZGNzaXNrL0dQVF9leGFtcGxlcyIsInJlcXVlc3RfaWQiOiJFQzgxOjlENzA6NUVCQzcxOjg5MDE1Qjo2NTM4MzZGQiIsInZpc2l0b3JfaWQiOiI3ODg3NzUzMjQ2NjA1NjAwMDMzIiwicmVnaW9uX2VkZ2UiOiJpYWQiLCJyZWdpb25fcmVuZGVyIjoiaWFkIn0=" data-turbo-transient="true" /><meta name="visitor-hmac" content="b368ae1d918d7ac5d199c8312d60013e727646601bbf33061298bb675a610245" data-turbo-transient="true" />


    <meta name="hovercard-subject-tag" content="repository:638935193" data-turbo-transient>
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="69985328" /><meta name="octolytics-actor-login" content="davidcsisk" /><meta name="octolytics-actor-hash" content="b9fbdc91a769b3dc1698f4fa06be86d3b50fc1aae7c52e624531463656f0ed39" />
  ...
  <meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-turbo-transient="true" />
    ...
    <meta name="user-login" content="davidcsisk">

  <link rel="sudo-modal" href="/sessions/sudo_modal">

    <meta name="viewport" content="width=device-width">
    
      <meta name="description" content="Examples of experimentation with Langchain, OpenAI API, PGvector and Pinecone vector database, etc - GPT_examples/example_loading-data-from-mssql-into-solr-vector-embeddings.py at main · davidcsisk/GPT_examples">
      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">
    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/davidcsisk/GPT_examples/blob/main/example_loading-data-from-mssql-into-solr-vector-embeddings.py" />
      <meta name="twitter:image:src" content="https://avatars.githubusercontent.com/u/69985328?s=400&amp;v=4" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary" /><meta name="twitter:title" content="GPT_examples/example_loading-data-from-mssql-into-solr-vector-embeddings.py at main · davidcsisk/GPT_examples" /><meta name="twitter:description" content="Examples of experimentation with Langchain, OpenAI API, PGvector and Pinecone vector database, etc - davidcsisk/GPT_examples" />
      <meta property="og:image" content="https://avatars.githubusercontent.com/u/69985328?s=400&amp;v=4" /><meta property="og:image:alt" content="Examples of experimentation with Langchain, OpenAI API, PGvector and Pinecone vector database, etc - davidcsisk/GPT_examples" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="GPT_examples/example_loading-data-from-mssql-into-solr-vector-embeddings.py at main · davidcsisk/GPT_examples" /><meta property="og:url" content="https://github.com/davidcsisk/GPT_examples/blob/main/example_loading-data-from-mssql-into-solr-vector-embeddings.py" /><meta property="og:description" content="Examples of experimentation with Langchain, OpenAI API, PGvector and Pinecone vector database, etc - davidcsisk/GPT_examples" />
      

      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/69985328/ws?session=eyJ2IjoiVjMiLCJ1Ijo2OTk4NTMyOCwicyI6MTIyNzM3ODY4MSwiYyI6MzA2NjA1Njk1LCJ0IjoxNjk4MTgyOTEyfQ==--9d6776f16e09b11964a76db778232f4fac89b3ff86637c9fb77d0acc126da5af" data-refresh-url="/_alive" data-session-id="f07b9b328a8c55b12e7a900c2ac5352b91dce54fb87c4e343a1d0e709db6c07d">
  ...
  <meta name="go-import" content="github.com/davidcsisk/GPT_examples git https://github.com/davidcsisk/GPT_examples.git">

  <meta name="octolytics-dimension-user_id" content="69985328" /><meta name="octolytics-dimension-user_login" content="davidcsisk" /><meta name="octolytics-dimension-repository_id" content="638935193" /><meta name="octolytics-dimension-repository_nwo" content="davidcsisk/GPT_examples" /><meta name="octolytics-dimension-repository_public" content="false" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="638935193" /><meta name="octolytics-dimension-repository_network_root_nwo" content="davidcsisk/GPT_examples" />
...
<script crossorigin="anonymous" defer="defer" type="application/javascript" src="https://github.githubassets.com/assets/command-palette-624c62d45c6c.js"></script>
  ...
  <button aria-label="Open global navigation menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-b1fc47db-0a64-438b-a5e7-4842835ea7bc" id="dialog-show-dialog-b1fc47db-0a64-438b-a5e7-4842835ea7bc" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-bg-transparent p-0 color-fg-muted">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-three-bars Button-visual">
    <path d="M1 2.75A.75.75 0 0 1 1.75 2h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 2.75Zm0 5A.75.75 0 0 1 1.75 7h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 7.75ZM1.75 12h12.5a.75.75 0 0 1 0 1.5H1.75a.75.75 0 0 1 0-1.5Z"></path>
</svg>
</button>  

<div class="Overlay--hidden Overlay-backdrop--side Overlay-backdrop--placement-left" data-modal-dialog-overlay>
  <modal-dialog data-target="deferred-side-panel.panel" role="dialog" id="dialog-b1fc47db-0a64-438b-a5e7-4842835ea7bc" aria-modal="true" aria-disabled="true" aria-labelledby="dialog-b1fc47db-0a64-438b-a5e7-4842835ea7bc-title" aria-describedby="dialog-b1fc47db-0a64-438b-a5e7-4842835ea7bc-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-b1fc47db-0a64-438b-a5e7-4842835ea7bc-title">
        Global navigation
      </h1>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-b1fc47db-0a64-438b-a5e7-4842835ea7bc" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g d" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;HOME&quot;,&quot;label&quot;:null}" id="item-12d05041-9c4a-4943-808a-f5d1295b801a" href="/dashboard" data-view-component="true" class="ActionListContent ActionListContent--visual16">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES&quot;,&quot;label&quot;:null}" id="item-af874c13-6a5f-48c7-bfb0-4a1fc6201dc1" href="/issues" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS&quot;,&quot;label&quot;:null}" id="item-f3204912-b414-445f-a34b-44fe066e705e" href="/pulls" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DISCUSSIONS&quot;,&quot;label&quot;:null}" id="item-cae44b25-df38-4c34-9852-86748b120c96" href="/discussions" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;CODESPACES&quot;,&quot;label&quot;:null}" id="item-2a65ac77-79cf-4dd6-ac50-7463d23c0894" href="https://github.com/codespaces" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;EXPLORE&quot;,&quot;label&quot;:null}" id="item-c9755b9e-09f6-4855-a6ce-33f4c4c2fb9f" href="/explore" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;MARKETPLACE&quot;,&quot;label&quot;:null}" id="item-9d59b5f4-ba47-43b3-b474-751a95444424" href="/marketplace" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
  ...
  <div class="AppHeader-context-compact">
        <button aria-expanded="false" aria-haspopup="dialog" aria-label="Page context: davidcsisk / GPT_examples" id="dialog-show-context-region-dialog" data-show-dialog-id="context-region-dialog" type="button" data-view-component="true" class="AppHeader-context-compact-trigger Truncate Button--secondary Button--medium Button box-shadow-none">    <span class="Button-content">
      <span class="Button-label"><span class="AppHeader-context-compact-lead">
                <span class="AppHeader-context-compact-parentItem">davidcsisk</span>
                <span class="no-wrap">&nbsp;/</span>

            </span>

            <strong class="AppHeader-context-compact-mainItem d-flex flex-items-center Truncate" >
  <span class="Truncate-text ">GPT_examples</span>
...
<div class="Overlay--hidden Overlay-backdrop--center" data-modal-dialog-overlay>
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <li>
      <a data-analytics-event="{&quot;category&quot;:&quot;SiteHeaderComponent&quot;,&quot;action&quot;:&quot;context_region_crumb&quot;,&quot;label&quot;:&quot;davidcsisk&quot;,&quot;screen_size&quot;:&quot;compact&quot;}" href="/davidcsisk" data-view-component="true" class="Link--primary Truncate d-flex flex-items-center py-1">
    ...
    <li>
      <a data-analytics-event="{&quot;category&quot;:&quot;SiteHeaderComponent&quot;,&quot;action&quot;:&quot;context_region_crumb&quot;,&quot;label&quot;:&quot;GPT_examples&quot;,&quot;screen_size&quot;:&quot;compact&quot;}" href="/davidcsisk/GPT_examples" data-view-component="true" class="Link--primary Truncate d-flex flex-items-center py-1">
        <span class="AppHeader-context-item-label Truncate-text ">
  ...
  <div class="AppHeader-context-full">
    ...
    <li>
      <a data-analytics-event="{&quot;category&quot;:&quot;SiteHeaderComponent&quot;,&quot;action&quot;:&quot;context_region_crumb&quot;,&quot;label&quot;:&quot;davidcsisk&quot;,&quot;screen_size&quot;:&quot;full&quot;}" data-hovercard-type="user" data-hovercard-url="/users/davidcsisk/hovercard" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/davidcsisk" data-view-component="true" class="AppHeader-context-item">
    ...
    <li>
      <a data-analytics-event="{&quot;category&quot;:&quot;SiteHeaderComponent&quot;,&quot;action&quot;:&quot;context_region_crumb&quot;,&quot;label&quot;:&quot;GPT_examples&quot;,&quot;screen_size&quot;:&quot;full&quot;}" href="/davidcsisk/GPT_examples" data-view-component="true" class="AppHeader-context-item">
        <span class="AppHeader-context-item-label  ">
...
<qbsearch-input class="search-input" data-scope="repo:davidcsisk/GPT_examples" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="rC2wAbg63_GCfLrR0FGk66l_JUdWlES-1D_NJb9ugL6FsdV0LRPHUBMFjbvstzMRdQkxMLxgwJxy1ENURQil5g" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="davidcsisk/GPT_examples" data-current-org="" data-current-owner="davidcsisk" data-logged-in="true">
  <div
...
<div class="AppHeader-search-whenRegular">
  <div class="AppHeader-search-wrap AppHeader-search-wrap--hasTrailing">
    ...
    <path d="m6.354 8.04-4.773 4.773a.75.75 0 1 0 1.061 1.06L7.945 8.57a.75.75 0 0 0 0-1.06L2.642 2.206a.75.75 0 0 0-1.06 1.061L6.353 8.04ZM8.75 11.5a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5h-5.5Z"></path>
      ...
      <tool-tip id="tooltip-df761481-f540-4c2c-8b52-70a3df7963ce" for="AppHeader-commandPalette-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Command palette</tool-tip>
  </div>
</div>
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-f7e0cdb6-3159-428d-8c77-8ee9571bc034" data-target="query-builder.input" data-action="
...
<template id="pencil-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-pencil">
    <path d="M11.013 1.427a1.75 1.75 0 0 1 2.474 0l1.086 1.086a1.75 1.75 0 0 1 0 2.474l-8.61 8.61c-.21.21-.47.364-.756.445l-3.251.93a.75.75 0 0 1-.927-.928l.929-3.25c.081-.286.235-.547.445-.758l8.61-8.61Zm.176 4.823L9.75 4.81l-6.286 6.287a.253.253 0 0 0-.064.108l-.558 1.953 1.953-.558a.253.253 0 0 0 .108-.064Zm1.238-3.763a.25.25 0 0 0-.354 0L10.811 3.75l1.439 1.44 1.263-1.263a.25.25 0 0 0 0-.354Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-f7e0cdb6-3159-428d-8c77-8ee9571bc034" hidden="hidden">
...
<div class="Overlay--hidden Overlay-backdrop--center" data-modal-dialog-overlay>
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="wFXmXjgQClYwoXEBvJHKUNn1iUpo3L29uYKrzbZ3VnWL2lxOfFXABxBDnS60naWzFNZvL9GIjI7DT5XxtaH8dg" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <div data-view-component="true" class="Overlay-body">        <div data-target="custom-scopes.customScopesModalDialogFlash"></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="NspXEsjLhTROoXSIvXSh01XREb6-BdU7P8SnsPdhDA1h_t3eod1of31qb23S8VhY0WCLZ-Vi16loCALbVQqghA" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="zA6Bs4EFFOtspZHRf5q7rQrReuHd1PW2AYINGAl7eB_V1iPesZT1ts1ZUuYt3bUj29L6kbDMpSq-SXOuNPQxbg" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input><input type="hidden" value="bPM_uRMtP86ZdYsNL1RgZZhQkN6VKLJ7EmmickjC52AmCLRaNisftQK7JzbTDDqzJ5LiZXbiohDr52whAL03bw" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
...
</button>  <tool-tip id="tooltip-15f16771-6c3b-47ad-98a1-468ef62173eb" for="global-create-menu-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Create new...</tool-tip>
</div>
...
<anchored-position id="global-create-menu-overlay" anchor="global-create-menu-button" align="end" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  ...
  <ul aria-labelledby="global-create-menu-button" id="global-create-menu-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
    ...
    <a href="/new" tabindex="-1" id="item-132be345-a0b2-4c51-8263-2d753b5738db" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo">
    <path d="M2 2.5A2.5 2.5 0 0 1 4.5 0h8.75a.75.75 0 0 1 .75.75v12.5a.75.75 0 0 1-.75.75h-2.5a.75.75 0 0 1 0-1.5h1.75v-2h-8a1 1 0 0 0-.714 1.7.75.75 0 1 1-1.072 1.05A2.495 2.495 0 0 1 2 11.5Zm10.5-1h-8a1 1 0 0 0-1 1v6.708A2.486 2.486 0 0 1 4.5 9h8ZM5 12.25a.25.25 0 0 1 .25-.25h3.5a.25.25 0 0 1 .25.25v3.25a.25.25 0 0 1-.4.2l-1.45-1.087a.249.249 0 0 0-.3 0L5.4 15.7a.25.25 0 0 1-.4-.2Z"></path>
</svg>
    ...
    <a href="/new/import" tabindex="-1" id="item-90e82d1b-8fce-432c-8576-4b2dd58b51bb" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a href="/codespaces/new" tabindex="-1" id="item-69cd35f3-6e7f-4d9b-b09f-4626333a0b92" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-codespaces">
    <path d="M0 11.25c0-.966.784-1.75 1.75-1.75h12.5c.966 0 1.75.784 1.75 1.75v3A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25Zm2-9.5C2 .784 2.784 0 3.75 0h8.5C13.216 0 14 .784 14 1.75v5a1.75 1.75 0 0 1-1.75 1.75h-8.5A1.75 1.75 0 0 1 2 6.75Zm1.75-.25a.25.25 0 0 0-.25.25v5c0 .138.112.25.25.25h8.5a.25.25 0 0 0 .25-.25v-5a.25.25 0 0 0-.25-.25Zm-2 9.5a.25.25 0 0 0-.25.25v3c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-3a.25.25 0 0 0-.25-.25Z"></path><path d="M7 12.75a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1-.75-.75Zm-4 0a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1-.75-.75Z"></path>
</svg>
    ...
    <a href="https://gist.github.com/" tabindex="-1" id="item-3585ef10-f15f-425f-8bee-30d15c1fa067" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
  ...
  <a href="/issues" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-7ef60cd6-46cf-4655-b98d-b955085581b8" aria-labelledby="tooltip-b10c10a4-295f-4341-93b6-a82a7c2b3f01" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened Button-visual">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
</a>  <tool-tip id="tooltip-b10c10a4-295f-4341-93b6-a82a7c2b3f01" for="icon-button-7ef60cd6-46cf-4655-b98d-b955085581b8" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Issues</tool-tip>
</div>
          <div data-view-component="true" class="Button-withTooltip">
  <a href="/pulls" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-55ba212f-30d0-4ab1-b076-9e8c9fff22e4" aria-labelledby="tooltip-7553d830-9674-4c88-b64f-b7991b49db4f" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request Button-visual">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
</a>  <tool-tip id="tooltip-7553d830-9674-4c88-b64f-b7991b49db4f" for="icon-button-55ba212f-30d0-4ab1-b076-9e8c9fff22e4" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Pull requests</tool-tip>
</div>
...
<notification-indicator data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6Njk5ODUzMjgiLCJ0IjoxNjk4MTgyOTEyfQ==--cbe3aedfd8d91fc855086e8f4fd5b452501ae59877e990720976511022c652d4" data-indicator-mode="none" data-tooltip-global="You have unread notifications" data-tooltip-unavailable="Notifications are unavailable at the moment." data-tooltip-none="You have no unread notifications" data-header-redesign-enabled="true" data-fetch-indicator-src="/notifications/indicator" data-fetch-indicator-enabled="true" data-view-component="true" class="js-socket-channel">
  ...
  >
    ...
    <tool-tip data-target="notification-indicator.tooltip" id="tooltip-2b650153-5b19-4ba5-8858-f31461320a14" for="AppHeader-notifications-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Notifications</tool-tip>
</notification-indicator>

        

        <div class="AppHeader-user">
          <deferred-side-panel data-url="/_side-panels/user?memex_enabled=true&amp;repository=GPT_examples&amp;user=davidcsisk&amp;user_can_create_organizations=true&amp;user_id=69985328">
  <include-fragment data-target="deferred-side-panel.fragment">
      <user-drawer-side-panel>
      <button aria-label="Open user account menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-3579edd9-2e0c-4195-9c3d-b44ef12e39e4" id="dialog-show-dialog-3579edd9-2e0c-4195-9c3d-b44ef12e39e4" type="button" data-view-component="true" class="AppHeader-logo Button--invisible Button--medium Button Button--invisible-noVisuals color-bg-transparent p-0">    <span class="Button-content">
      <span class="Button-label"><img src="https://avatars.githubusercontent.com/u/69985328?v=4" alt="" size="32" height="32" width="32" data-view-component="true" class="avatar circle" /></span>
    </span>
</button>  

<div class="Overlay--hidden Overlay-backdrop--side Overlay-backdrop--placement-right" data-modal-dialog-overlay>
  <modal-dialog data-target="deferred-side-panel.panel" role="dialog" id="dialog-3579edd9-2e0c-4195-9c3d-b44ef12e39e4" aria-modal="true" aria-disabled="true" aria-labelledby="dialog-3579edd9-2e0c-4195-9c3d-b44ef12e39e4-title" aria-describedby="dialog-3579edd9-2e0c-4195-9c3d-b44ef12e39e4-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-3579edd9-2e0c-4195-9c3d-b44ef12e39e4-title">
        Account menu
      </h1>
            <div data-view-component="true" class="d-flex">
      <div data-view-component="true" class="AppHeader-logo position-relative">
        <img src="https://avatars.githubusercontent.com/u/69985328?v=4" alt="" size="32" height="32" width="32" data-view-component="true" class="avatar circle" />
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-3579edd9-2e0c-4195-9c3d-b44ef12e39e4" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg></button>
    </div>
  </div>
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-e883aff8-2b57-4f10-ad32-f8a77f432529" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROFILE&quot;,&quot;label&quot;:null}" id="item-8738b5c1-0733-4389-8c9a-102018bab30b" href="https://github.com/davidcsisk" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-0085d494-bbc5-430a-9ca8-735a2a49642d" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_REPOSITORIES&quot;,&quot;label&quot;:null}" id="item-6bc8ef50-07e6-4249-8bd1-58418a5c525a" href="/davidcsisk?tab=repositories" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo">
    <path d="M2 2.5A2.5 2.5 0 0 1 4.5 0h8.75a.75.75 0 0 1 .75.75v12.5a.75.75 0 0 1-.75.75h-2.5a.75.75 0 0 1 0-1.5h1.75v-2h-8a1 1 0 0 0-.714 1.7.75.75 0 1 1-1.072 1.05A2.495 2.495 0 0 1 2 11.5Zm10.5-1h-8a1 1 0 0 0-1 1v6.708A2.486 2.486 0 0 1 4.5 9h8ZM5 12.25a.25.25 0 0 1 .25-.25h3.5a.25.25 0 0 1 .25.25v3.25a.25.25 0 0 1-.4.2l-1.45-1.087a.249.249 0 0 0-.3 0L5.4 15.7a.25.25 0 0 1-.4-.2Z"></path>
</svg>
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_PROJECTS&quot;,&quot;label&quot;:null}" id="item-7fbcb52e-6f51-45d3-87f8-303b64d40a58" href="/davidcsisk?tab=projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-project">
    <path d="M1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25V1.75C0 .784.784 0 1.75 0ZM1.5 1.75v12.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25V1.75a.25.25 0 0 0-.25-.25H1.75a.25.25 0 0 0-.25.25ZM11.75 3a.75.75 0 0 1 .75.75v7.5a.75.75 0 0 1-1.5 0v-7.5a.75.75 0 0 1 .75-.75Zm-8.25.75a.75.75 0 0 1 1.5 0v5.5a.75.75 0 0 1-1.5 0ZM8 3a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 8 3Z"></path>
</svg>
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-9a08b9ef-9424-4a75-bbf8-e77b7c855a69" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_STARS&quot;,&quot;label&quot;:null}" id="item-b4beb4ee-7cd4-4df6-85c9-624c0d7709e1" href="/davidcsisk?tab=stars" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;SPONSORS&quot;,&quot;label&quot;:null}" id="item-612e9d69-b899-4070-97bc-4b6fbcb5ae20" href="/sponsors/accounts" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_GISTS&quot;,&quot;label&quot;:null}" id="item-a6aa0e7b-07c3-4cf9-8c77-e54690508610" href="https://gist.github.com/mine" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-9a874516-95c8-4cd0-8cfd-47720430cdac" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-b738307b-a5be-4f21-85c7-63e399a1db2f" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-916bb260-df67-4021-978d-9ecdc625c706" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;SETTINGS&quot;,&quot;label&quot;:null}" id="item-37bebee8-96ea-48ec-ae65-332dbce3b5e8" href="/settings/profile" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DOCS&quot;,&quot;label&quot;:null}" id="item-ed6aa967-c12f-4431-b126-6fee871d966e" href="https://docs.github.com" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;SUPPORT&quot;,&quot;label&quot;:null}" id="item-0a45258f-eceb-4252-8936-c5149b6475b5" href="https://support.github.com" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-people">
    <path d="M2 5.5a3.5 3.5 0 1 1 5.898 2.549 5.508 5.508 0 0 1 3.034 4.084.75.75 0 1 1-1.482.235 4 4 0 0 0-7.9 0 .75.75 0 0 1-1.482-.236A5.507 5.507 0 0 1 3.102 8.05 3.493 3.493 0 0 1 2 5.5ZM11 4a3.001 3.001 0 0 1 2.22 5.018 5.01 5.01 0 0 1 2.56 3.012.749.749 0 0 1-.885.954.752.752 0 0 1-.549-.514 3.507 3.507 0 0 0-2.522-2.372.75.75 0 0 1-.574-.73v-.352a.75.75 0 0 1 .416-.672A1.5 1.5 0 0 0 11 5.5.75.75 0 0 1 11 4Zm-5.5-.5a2 2 0 1 0-.001 3.999A2 2 0 0 0 5.5 3.5Z"></path>
</svg>
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;LOGOUT&quot;,&quot;label&quot;:null}" id="item-a99b2a9d-bb27-4515-a827-b2f9c95ca73a" href="/logout" data-view-component="true" class="ActionListContent">
...
<site-header-logged-in-user-menu>
  ...
  <a id="code-tab" href="/davidcsisk/GPT_examples" data-tab-item="i0code-tab" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages repo_deployments repo_attestations /davidcsisk/GPT_examples" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-hotkey="g c" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Code&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
    ...
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <li data-view-component="true" class="d-inline-flex">
  <a id="issues-tab" href="/davidcsisk/GPT_examples/issues" data-tab-item="i1issues-tab" data-selected-links="repo_issues repo_labels repo_milestones /davidcsisk/GPT_examples/issues" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Issues&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
    ...
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
      ...
      <li data-view-component="true" class="d-inline-flex">
  <a id="pull-requests-tab" href="/davidcsisk/GPT_examples/pulls" data-tab-item="i2pull-requests-tab" data-selected-links="repo_pulls checks /davidcsisk/GPT_examples/pulls" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Pull requests&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
    ...
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
      ...
      <li data-view-component="true" class="d-inline-flex">
  <a id="actions-tab" href="/davidcsisk/GPT_examples/actions" data-tab-item="i3actions-tab" data-selected-links="repo_actions /davidcsisk/GPT_examples/actions" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-hotkey="g a" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Actions&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
    ...
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
      ...
      <li data-view-component="true" class="d-inline-flex">
  <a id="projects-tab" href="/davidcsisk/GPT_examples/projects" data-tab-item="i4projects-tab" data-selected-links="repo_projects new_repo_project repo_project /davidcsisk/GPT_examples/projects" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-hotkey="g b" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Projects&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
    ...
    <path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25ZM6.5 6.5v8h7.75a.25.25 0 0 0 .25-.25V6.5Zm8-1.5V1.75a.25.25 0 0 0-.25-.25H6.5V5Zm-13 1.5v7.75c0 .138.112.25.25.25H5v-8ZM5 5V1.5H1.75a.25.25 0 0 0-.25.25V5Z"></path>
      ...
      <li data-view-component="true" class="d-inline-flex">
  <a id="security-tab" href="/davidcsisk/GPT_examples/security" data-tab-item="i5security-tab" data-selected-links="security overview alerts policy token_scanning code_scanning /davidcsisk/GPT_examples/security" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-hotkey="g s" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Security&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
    ...
    <path d="M7.467.133a1.748 1.748 0 0 1 1.066 0l5.25 1.68A1.75 1.75 0 0 1 15 3.48V7c0 1.566-.32 3.182-1.303 4.682-.983 1.498-2.585 2.813-5.032 3.855a1.697 1.697 0 0 1-1.33 0c-2.447-1.042-4.049-2.357-5.032-3.855C1.32 10.182 1 8.566 1 7V3.48a1.75 1.75 0 0 1 1.217-1.667Zm.61 1.429a.25.25 0 0 0-.153 0l-5.25 1.68a.25.25 0 0 0-.174.238V7c0 1.358.275 2.666 1.057 3.86.784 1.194 2.121 2.34 4.366 3.297a.196.196 0 0 0 .154 0c2.245-.956 3.582-2.104 4.366-3.298C13.225 9.666 13.5 8.36 13.5 7V3.48a.251.251 0 0 0-.174-.237l-5.25-1.68ZM8.75 4.75v3a.75.75 0 0 1-1.5 0v-3a.75.75 0 0 1 1.5 0ZM9 10.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
        ...
        <span data-content="Security">Security</span>
          <include-fragment src="/davidcsisk/GPT_examples/security/overall-count" accept="text/fragment+html"></include-fragment>

    
</a></li>
      <li data-view-component="true" class="d-inline-flex">
  <a id="insights-tab" href="/davidcsisk/GPT_examples/network/dependencies" data-tab-item="i6insights-tab" data-selected-links="repo_graphs repo_contributors dependency_graph dependabot_updates pulse people community /davidcsisk/GPT_examples/network/dependencies" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Insights&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
    ...
    <details-menu role="menu" data-view-component="true" class="dropdown-menu dropdown-menu-sw">
          <ul>
              <li data-menu-item="i0code-tab" hidden>
                <a role="menuitem" class="js-selected-navigation-item dropdown-item" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages repo_deployments repo_attestations /davidcsisk/GPT_examples" href="/davidcsisk/GPT_examples">
                  Code
</a>              </li>
              <li data-menu-item="i1issues-tab" hidden>
                <a role="menuitem" class="js-selected-navigation-item dropdown-item" data-selected-links="repo_issues repo_labels repo_milestones /davidcsisk/GPT_examples/issues" href="/davidcsisk/GPT_examples/issues">
                  Issues
</a>              </li>
              <li data-menu-item="i2pull-requests-tab" hidden>
                <a role="menuitem" class="js-selected-navigation-item dropdown-item" data-selected-links="repo_pulls checks /davidcsisk/GPT_examples/pulls" href="/davidcsisk/GPT_examples/pulls">
                  Pull requests
</a>              </li>
              <li data-menu-item="i3actions-tab" hidden>
                <a role="menuitem" class="js-selected-navigation-item dropdown-item" data-selected-links="repo_actions /davidcsisk/GPT_examples/actions" href="/davidcsisk/GPT_examples/actions">
                  Actions
</a>              </li>
              <li data-menu-item="i4projects-tab" hidden>
                <a role="menuitem" class="js-selected-navigation-item dropdown-item" data-selected-links="repo_projects new_repo_project repo_project /davidcsisk/GPT_examples/projects" href="/davidcsisk/GPT_examples/projects">
                  Projects
</a>              </li>
              <li data-menu-item="i5security-tab" hidden>
                <a role="menuitem" class="js-selected-navigation-item dropdown-item" data-selected-links="security overview alerts policy token_scanning code_scanning /davidcsisk/GPT_examples/security" href="/davidcsisk/GPT_examples/security">
                  Security
</a>              </li>
              <li data-menu-item="i6insights-tab" hidden>
                <a role="menuitem" class="js-selected-navigation-item dropdown-item" data-selected-links="repo_graphs repo_contributors dependency_graph dependabot_updates pulse people community /davidcsisk/GPT_examples/network/dependencies" href="/davidcsisk/GPT_examples/network/dependencies">
                  Insights
</a>              </li>
              <li data-menu-item="i7settings-tab" hidden>
                <a role="menuitem" class="js-selected-navigation-item dropdown-item" data-selected-links="code_review_limits codespaces_repository_settings collaborators custom_tabs hooks integration_installations interaction_limits issue_template_editor key_links_settings notifications repo_actions_settings repo_announcements repo_branch_settings repo_keys_settings repo_pages_settings repo_rule_insights repo_rulesets repo_protected_tags_settings repo_settings reported_content repo_custom_properties repository_actions_settings_add_new_runner repository_actions_settings_general repository_actions_settings_runners repository_environments role_details secrets secrets_settings_actions secrets_settings_codespaces secrets_settings_dependabot security_analysis /davidcsisk/GPT_examples/settings" href="/davidcsisk/GPT_examples/settings">
                  Settings
</a>              </li>
          </ul>
</details-menu>
  ...
  <button id="icon-button-0049d836-7478-4ab1-98f4-4b0b889ba210" aria-labelledby="tooltip-900e7816-8df2-4600-91ad-623d0d51c642" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium js-flash-close">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button>  <tool-tip id="tooltip-900e7816-8df2-4600-91ad-623d0d51c642" for="icon-button-0049d836-7478-4ab1-98f4-4b0b889ba210" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
</div>
...
<div class="flash flash-full   {{ className }}">
  <div class="px-2" >
    ...
    <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6Njk5ODUzMjgiLCJ0IjoxNjk4MTgyOTEyfQ==--cbe3aedfd8d91fc855086e8f4fd5b452501ae59877e990720976511022c652d4" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
>
  ...
  <details-dialog class="command-palette-details-dialog d-flex flex-column flex-justify-center height-fit" aria-label="Command palette">
    <command-palette
      ...
      return-to=/davidcsisk/GPT_examples/blob/main/example_loading-data-from-mssql-into-solr-vector-embeddings.py
      user-id="69985328"
        ...
        <command-palette-scope >
          <div data-target="command-palette-scope.placeholder" hidden class="color-fg-subtle">/&nbsp;&nbsp;<span class="text-semibold color-fg-default">...</span>&nbsp;&nbsp;/&nbsp;&nbsp;</div>
              <command-palette-token
                data-text="davidcsisk"
                data-id="MDQ6VXNlcjY5OTg1MzI4"
                data-type="owner"
                data-value="davidcsisk"
                data-targets="command-palette-scope.tokens"
                class="color-fg-default text-semibold"
                style="white-space:nowrap;line-height:20px;"
                >davidcsisk<span class="color-fg-subtle text-normal">&nbsp;&nbsp;/&nbsp;&nbsp;</span></command-palette-token>
              <command-palette-token
                data-text="GPT_examples"
                data-id="R_kgDOJhVgmQ"
                data-type="repository"
                data-value="GPT_examples"
                data-targets="command-palette-scope.tokens"
                class="color-fg-default text-semibold"
                style="white-space:nowrap;line-height:20px;"
                >GPT_examples<span class="color-fg-subtle text-normal">&nbsp;&nbsp;/&nbsp;&nbsp;</span></command-palette-token>
        </command-palette-scope>
...
</button>    <tool-tip id="tooltip-4d36f064-37e9-43bb-9c58-3593183f3f21" for="command-palette-clear-button" popover="manual" data-direction="w" data-type="label" data-view-component="true" class="sr-only position-absolute">Clear Command Palette</tool-tip>
</div>
      </command-palette-input>

      <command-palette-page-stack
        data-default-scope-id="R_kgDOJhVgmQ"
    ...
    <path d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
        ...
        <div hidden>
            ...
            <command-palette-page
              data-page-title="davidcsisk"
              data-scope-id="MDQ6VXNlcjY5OTg1MzI4"
            ...
            <command-palette-page
              data-page-title="GPT_examples"
              data-scope-id="R_kgDOJhVgmQ"
...
<turbo-frame id="repo-content-turbo-frame" target="_top" data-turbo-action="advance" class="">
  ...
  <a href="https://github.dev/" class="d-none js-github-dev-new-tab-shortcut" data-hotkey="Shift+.,Shift+&gt;,&gt;" target="_blank" rel="noopener noreferrer">Open in a new github.dev tab</a>
    <a class="d-none" data-hotkey=",,Alt+Meta+≤,Control+Alt+," target="_blank" href="/codespaces/new/davidcsisk/GPT_examples/tree/main?resume=1">Open in codespace</a>
...
<react-app
  ...
  initial-path="/davidcsisk/GPT_examples/blob/main/example_loading-data-from-mssql-into-solr-vector-embeddings.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":true,"fileTree":{"":{"items":[{"name":"Ask A Book Questions.ipynb","path":"Ask A Book Questions.ipynb","contentType":"file"},{"name":"GPT4All_notes.txt","path":"GPT4All_notes.txt","contentType":"file"},{"name":"LICENSE","path":"LICENSE","contentType":"file"},{"name":"Langchain-OpenAI_simple-example.ipynb","path":"Langchain-OpenAI_simple-example.ipynb","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"Reagan-1981-State-of-the-Union-address.txt","path":"Reagan-1981-State-of-the-Union-address.txt","contentType":"file"},{"name":"demo-pgvector-gpt4all.py","path":"demo-pgvector-gpt4all.py","contentType":"file"},{"name":"demo-pgvector-openai.py","path":"demo-pgvector-openai.py","contentType":"file"},{"name":"example-post-docs-to-solr.py","path":"example-post-docs-to-solr.py","contentType":"file"},{"name":"example_loading-data-from-mssql-into-solr-vector-embeddings.py","path":"example_loading-data-from-mssql-into-solr-vector-embeddings.py","contentType":"file"},{"name":"example_update-solr-with-1024-dimension-vector.py","path":"example_update-solr-with-1024-dimension-vector.py","contentType":"file"},{"name":"get-doc-count-from-solr-example.py","path":"get-doc-count-from-solr-example.py","contentType":"file"},{"name":"get-max-id-in-solr-collection.py","path":"get-max-id-in-solr-collection.py","contentType":"file"},{"name":"parsing-json-from-an-API-call-to-Dataframe_example.py","path":"parsing-json-from-an-API-call-to-Dataframe_example.py","contentType":"file"},{"name":"pgvector-on-debian11.txt","path":"pgvector-on-debian11.txt","contentType":"file"},{"name":"rest-api-example_weatherstack.py","path":"rest-api-example_weatherstack.py","contentType":"file"},{"name":"test-GPT4all.py","path":"test-GPT4all.py","contentType":"file"},{"name":"test-openai-pgvector.py","path":"test-openai-pgvector.py","contentType":"file"},{"name":"test-request-with-parameters_vector-search-knn-example.py","path":"test-request-with-parameters_vector-search-knn-example.py","contentType":"file"},{"name":"test_hugging-face_sentence-transformersall-MiniLM-L6-v2.py","path":"test_hugging-face_sentence-transformersall-MiniLM-L6-v2.py","contentType":"file"},{"name":"test_hugging-face_sentence-transformersstsb-bert-large.py","path":"test_hugging-face_sentence-transformersstsb-bert-large.py","contentType":"file"}],"totalCount":21}},"fileTreeProcessingTime":4.300534,"foldersToFetch":[],"reducedMotionEnabled":"system","repo":{"id":638935193,"defaultBranch":"main","name":"GPT_examples","ownerLogin":"davidcsisk","currentUserCanPush":true,"isFork":false,"isEmpty":false,"createdAt":"2023-05-10T08:17:48.000-04:00","ownerAvatar":"https://avatars.githubusercontent.com/u/69985328?v=4","public":false,"private":true,"isOrgOwned":false},"symbolsExpanded":true,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1697061374.0","canEdit":true,"refType":"branch","currentOid":"3ac8821727a0e40f703fcbb531d7b39fe3c3ea16"},"path":"example_loading-data-from-mssql-into-solr-vector-embeddings.py","currentUser":{"id":69985328,"login":"davidcsisk","userEmail":"davidcsisk@gmail.com"},"blob":{"rawLines":["# This script does the following:\r","# 1) Queries ATS to get a batch of job data and stores it in a dataframe\r","# 2) Calls the candidate/job matching model API with the batch of rows\r","# 3) Stores the vector embedding results from the API in a dataframe\r","# 4) Outputs the final data as JSON posted to Solr\r","\r","# This calls our dev AzuleML endpoint with candidate or job data, and catches the vector data returned by the model\r","#POST http://52.151.224.249:80/api/v1/service/futuresearch-embedding/score\r","#inputdata = {\"data\": [{\"id\": 0, \"text\": \"Financial Controller\"}, \r","#          {\"id\": 1, \"text\": \"Vice President of Personal Finance\"}]}\r","# The API call can accept up to 500 records per call.\r","# Output is id, title, and 32 dimension vector embedding.\r","\r","# Job query:       select top 500 jobPostingID, title from bullhorn1.BH_JobOpportunity where title is not null order by 1;\r","\r","import requests\r","import os, sys\r","import json\r","import pandas as pd\r","from sqlalchemy import create_engine #Note: Latest SQLalchemy2.x will not work with Pandas 1.5.x\r","import datetime\r","\r","\r","# URL for the vector embedding API call\r","model_url = 'http://52.151.224.249:80/api/v1/service/futuresearch-embedding/score'\r","\r","# Solr POST url\r","#solr_url = 'http://mrksolr1.bos.bullhorn.com:8983/solr/sisk-test-1/update'\r","solr_url = 'http://mrksolr1.bos.bullhorn.com:8983/solr/soliant-jobs/update'\r","#solr_url = 'http://devsolr1.dev.bullhorn.com:8983/solr/sisk-test-collection/update'\r","\r","# For posting documents to Solr, set the content type to JSON\r","solr_headers = {'Content-type': 'application/json'}\r","\r","# Add the commit parameter to the URL to enable auto-commit\r","solr_url_with_commit = f'{solr_url}?commit=true'\r","\r","# Read the connection info from a conn file in the script directory, and open a connection to SQLServer\r","connfile = 'mssql.conn'\r","with open(connfile) as f:\r","    conninfo = f.read()\r","engine_mssql = create_engine(conninfo, encoding='utf16', execution_options={\"isolation_level\": \"READ UNCOMMITTED\"})\r","\r","# File that tracks last ID loaded to Solr\r","last_id_file = 'state-jobs-last-id.cfg'\r","\r","# Check that the lastID file already exists...if not, create it and set the lastID to 0 \r","if os.path.exists(last_id_file) == False: \r","    with open(last_id_file, 'w') as f:\r","        f.write('0')\r","\r","with open(last_id_file) as f:\r","    last_id = f.read()\r","\r","print(f\"{datetime.datetime.now()}: {sys.argv[0]} Starting executing with lastID {last_id}...\")\r","\r","row_count = 1 # Set this to an artificial value to get into the first pass of the loop\r","\r","while row_count \u003e 0: \r","    # Get the last known last ID processed\r","    with open(last_id_file) as f:\r","        last_id = f.read()\r","\r","    job_query_sql = 'select top 500 jobPostingID id, title text from bullhorn1.BH_JobOpportunity \\\r","                     where title is not null and jobPostingID \u003e ' + last_id + 'order by 1;'\r","    df_jobdata = pd.read_sql(job_query_sql, engine_mssql)\r","    row_count = df_jobdata.shape[0]\r","    if row_count \u003e 0:\r","        last_id = str(df_jobdata['id'].tail(1).item())\r","    else:\r","        break\r","\r","    # Output the batch of rows to a dictionary, then wrap the dict in another dict to get the right JSON format for the API call\r","    dict_jobdata = df_jobdata.to_dict('records')\r","    inputdata = {'data': dict_jobdata }   # Nest the DF inside another JSON document so it looks like our sample input data\r","\r","    # Make the API call\r","    response = requests.post(model_url, json = inputdata)\r","\r","    # Check if the call succeeded\r","    #print('RESPONSE: ', response.status_code) # Should be 200\r","    #print(json.dumps(response.json(), indent=2))  # Print readable structured json\r","\r","    # Put the json into a dictionary\r","    response_dict = response.json()\r","\r","    # Make a dataframe from the output section of the dictionary\r","    df_jobvectors = pd.DataFrame(response_dict['output'])\r","    # Set column names to \"title\" and \"vector\"...we've already created a vector field with 32 dimensions and datatype DenseVectorField\r","    df_jobvectors = df_jobvectors.rename({'text':'title', 'embedding':'vector'}, axis='columns')  # Should now have id, title, vector\r","    #print(df_jobvectors)\r","\r","    data_payload = df_jobvectors.to_json(orient='records')\r","    \r","    #print(\"Sent: \", data_payload)\r","    add_docs = requests.post(solr_url_with_commit, data=data_payload, headers=solr_headers)\r","    #print(\"Response: \", add_docs.json())\r","    print(f\"{datetime.datetime.now()}: {sys.argv[0]} Last ID: {last_id}\")\r","    #print(\".\", end=\"\")\r","\r","    with open(last_id_file, 'w') as f:\r","        f.write(last_id)\r","    \r","print(f\"{datetime.datetime.now()}: {sys.argv[0]} \\nFinished executing...\")\r"],"stylingDirectives":[[{"start":0,"end":34,"cssClass":"pl-c"}],[{"start":0,"end":73,"cssClass":"pl-c"}],[{"start":0,"end":71,"cssClass":"pl-c"}],[{"start":0,"end":69,"cssClass":"pl-c"}],[{"start":0,"end":51,"cssClass":"pl-c"}],[],[{"start":0,"end":116,"cssClass":"pl-c"}],[{"start":0,"end":75,"cssClass":"pl-c"}],[{"start":0,"end":67,"cssClass":"pl-c"}],[{"start":0,"end":69,"cssClass":"pl-c"}],[{"start":0,"end":54,"cssClass":"pl-c"}],[{"start":0,"end":58,"cssClass":"pl-c"}],[],[{"start":0,"end":123,"cssClass":"pl-c"}],[],[{"start":0,"end":6,"cssClass":"pl-k"},{"start":7,"end":15,"cssClass":"pl-s1"}],[{"start":0,"end":6,"cssClass":"pl-k"},{"start":7,"end":9,"cssClass":"pl-s1"},{"start":11,"end":14,"cssClass":"pl-s1"}],[{"start":0,"end":6,"cssClass":"pl-k"},{"start":7,"end":11,"cssClass":"pl-s1"}],[{"start":0,"end":6,"cssClass":"pl-k"},{"start":7,"end":13,"cssClass":"pl-s1"},{"start":14,"end":16,"cssClass":"pl-k"},{"start":17,"end":19,"cssClass":"pl-s1"}],[{"start":0,"end":4,"cssClass":"pl-k"},{"start":5,"end":15,"cssClass":"pl-s1"},{"start":16,"end":22,"cssClass":"pl-k"},{"start":23,"end":36,"cssClass":"pl-s1"},{"start":37,"end":97,"cssClass":"pl-c"}],[{"start":0,"end":6,"cssClass":"pl-k"},{"start":7,"end":15,"cssClass":"pl-s1"}],[],[],[{"start":0,"end":40,"cssClass":"pl-c"}],[{"start":0,"end":9,"cssClass":"pl-s1"},{"start":10,"end":11,"cssClass":"pl-c1"},{"start":12,"end":82,"cssClass":"pl-s"}],[],[{"start":0,"end":16,"cssClass":"pl-c"}],[{"start":0,"end":76,"cssClass":"pl-c"}],[{"start":0,"end":8,"cssClass":"pl-s1"},{"start":9,"end":10,"cssClass":"pl-c1"},{"start":11,"end":75,"cssClass":"pl-s"}],[{"start":0,"end":85,"cssClass":"pl-c"}],[],[{"start":0,"end":62,"cssClass":"pl-c"}],[{"start":0,"end":12,"cssClass":"pl-s1"},{"start":13,"end":14,"cssClass":"pl-c1"},{"start":16,"end":30,"cssClass":"pl-s"},{"start":32,"end":50,"cssClass":"pl-s"}],[],[{"start":0,"end":60,"cssClass":"pl-c"}],[{"start":0,"end":20,"cssClass":"pl-s1"},{"start":21,"end":22,"cssClass":"pl-c1"},{"start":23,"end":48,"cssClass":"pl-s"},{"start":25,"end":35,"cssClass":"pl-s1"},{"start":25,"end":26,"cssClass":"pl-kos"},{"start":26,"end":34,"cssClass":"pl-s1"},{"start":34,"end":35,"cssClass":"pl-kos"}],[],[{"start":0,"end":104,"cssClass":"pl-c"}],[{"start":0,"end":8,"cssClass":"pl-s1"},{"start":9,"end":10,"cssClass":"pl-c1"},{"start":11,"end":23,"cssClass":"pl-s"}],[{"start":0,"end":4,"cssClass":"pl-k"},{"start":5,"end":9,"cssClass":"pl-en"},{"start":10,"end":18,"cssClass":"pl-s1"},{"start":20,"end":22,"cssClass":"pl-k"},{"start":23,"end":24,"cssClass":"pl-s1"}],[{"start":4,"end":12,"cssClass":"pl-s1"},{"start":13,"end":14,"cssClass":"pl-c1"},{"start":15,"end":16,"cssClass":"pl-s1"},{"start":17,"end":21,"cssClass":"pl-en"}],[{"start":0,"end":12,"cssClass":"pl-s1"},{"start":13,"end":14,"cssClass":"pl-c1"},{"start":15,"end":28,"cssClass":"pl-en"},{"start":29,"end":37,"cssClass":"pl-s1"},{"start":39,"end":47,"cssClass":"pl-s1"},{"start":47,"end":48,"cssClass":"pl-c1"},{"start":48,"end":55,"cssClass":"pl-s"},{"start":57,"end":74,"cssClass":"pl-s1"},{"start":74,"end":75,"cssClass":"pl-c1"},{"start":76,"end":93,"cssClass":"pl-s"},{"start":95,"end":113,"cssClass":"pl-s"}],[],[{"start":0,"end":42,"cssClass":"pl-c"}],[{"start":0,"end":12,"cssClass":"pl-s1"},{"start":13,"end":14,"cssClass":"pl-c1"},{"start":15,"end":39,"cssClass":"pl-s"}],[],[{"start":0,"end":89,"cssClass":"pl-c"}],[{"start":0,"end":2,"cssClass":"pl-k"},{"start":3,"end":5,"cssClass":"pl-s1"},{"start":6,"end":10,"cssClass":"pl-s1"},{"start":11,"end":17,"cssClass":"pl-en"},{"start":18,"end":30,"cssClass":"pl-s1"},{"start":32,"end":34,"cssClass":"pl-c1"},{"start":35,"end":40,"cssClass":"pl-c1"}],[{"start":4,"end":8,"cssClass":"pl-k"},{"start":9,"end":13,"cssClass":"pl-en"},{"start":14,"end":26,"cssClass":"pl-s1"},{"start":28,"end":31,"cssClass":"pl-s"},{"start":33,"end":35,"cssClass":"pl-k"},{"start":36,"end":37,"cssClass":"pl-s1"}],[{"start":8,"end":9,"cssClass":"pl-s1"},{"start":10,"end":15,"cssClass":"pl-en"},{"start":16,"end":19,"cssClass":"pl-s"}],[],[{"start":0,"end":4,"cssClass":"pl-k"},{"start":5,"end":9,"cssClass":"pl-en"},{"start":10,"end":22,"cssClass":"pl-s1"},{"start":24,"end":26,"cssClass":"pl-k"},{"start":27,"end":28,"cssClass":"pl-s1"}],[{"start":4,"end":11,"cssClass":"pl-s1"},{"start":12,"end":13,"cssClass":"pl-c1"},{"start":14,"end":15,"cssClass":"pl-s1"},{"start":16,"end":20,"cssClass":"pl-en"}],[],[{"start":0,"end":5,"cssClass":"pl-en"},{"start":6,"end":93,"cssClass":"pl-s"},{"start":8,"end":33,"cssClass":"pl-s1"},{"start":8,"end":9,"cssClass":"pl-kos"},{"start":9,"end":17,"cssClass":"pl-s1"},{"start":18,"end":26,"cssClass":"pl-s1"},{"start":27,"end":30,"cssClass":"pl-en"},{"start":32,"end":33,"cssClass":"pl-kos"},{"start":35,"end":48,"cssClass":"pl-s1"},{"start":35,"end":36,"cssClass":"pl-kos"},{"start":36,"end":39,"cssClass":"pl-s1"},{"start":40,"end":44,"cssClass":"pl-s1"},{"start":45,"end":46,"cssClass":"pl-c1"},{"start":47,"end":48,"cssClass":"pl-kos"},{"start":80,"end":89,"cssClass":"pl-s1"},{"start":80,"end":81,"cssClass":"pl-kos"},{"start":81,"end":88,"cssClass":"pl-s1"},{"start":88,"end":89,"cssClass":"pl-kos"}],[],[{"start":0,"end":9,"cssClass":"pl-s1"},{"start":10,"end":11,"cssClass":"pl-c1"},{"start":12,"end":13,"cssClass":"pl-c1"},{"start":14,"end":87,"cssClass":"pl-c"}],[],[{"start":0,"end":5,"cssClass":"pl-k"},{"start":6,"end":15,"cssClass":"pl-s1"},{"start":16,"end":17,"cssClass":"pl-c1"},{"start":18,"end":19,"cssClass":"pl-c1"}],[{"start":4,"end":43,"cssClass":"pl-c"}],[{"start":4,"end":8,"cssClass":"pl-k"},{"start":9,"end":13,"cssClass":"pl-en"},{"start":14,"end":26,"cssClass":"pl-s1"},{"start":28,"end":30,"cssClass":"pl-k"},{"start":31,"end":32,"cssClass":"pl-s1"}],[{"start":8,"end":15,"cssClass":"pl-s1"},{"start":16,"end":17,"cssClass":"pl-c1"},{"start":18,"end":19,"cssClass":"pl-s1"},{"start":20,"end":24,"cssClass":"pl-en"}],[],[{"start":4,"end":17,"cssClass":"pl-s1"},{"start":18,"end":19,"cssClass":"pl-c1"},{"start":20,"end":99,"cssClass":"pl-s"},{"start":97,"end":99,"cssClass":"pl-cce"}],[{"start":0,"end":65,"cssClass":"pl-s"},{"start":0,"end":0,"cssClass":"pl-cce"},{"start":66,"end":67,"cssClass":"pl-c1"},{"start":68,"end":75,"cssClass":"pl-s1"},{"start":76,"end":77,"cssClass":"pl-c1"},{"start":78,"end":91,"cssClass":"pl-s"}],[{"start":4,"end":14,"cssClass":"pl-s1"},{"start":15,"end":16,"cssClass":"pl-c1"},{"start":17,"end":19,"cssClass":"pl-s1"},{"start":20,"end":28,"cssClass":"pl-en"},{"start":29,"end":42,"cssClass":"pl-s1"},{"start":44,"end":56,"cssClass":"pl-s1"}],[{"start":4,"end":13,"cssClass":"pl-s1"},{"start":14,"end":15,"cssClass":"pl-c1"},{"start":16,"end":26,"cssClass":"pl-s1"},{"start":27,"end":32,"cssClass":"pl-s1"},{"start":33,"end":34,"cssClass":"pl-c1"}],[{"start":4,"end":6,"cssClass":"pl-k"},{"start":7,"end":16,"cssClass":"pl-s1"},{"start":17,"end":18,"cssClass":"pl-c1"},{"start":19,"end":20,"cssClass":"pl-c1"}],[{"start":8,"end":15,"cssClass":"pl-s1"},{"start":16,"end":17,"cssClass":"pl-c1"},{"start":18,"end":21,"cssClass":"pl-en"},{"start":22,"end":32,"cssClass":"pl-s1"},{"start":33,"end":37,"cssClass":"pl-s"},{"start":39,"end":43,"cssClass":"pl-en"},{"start":44,"end":45,"cssClass":"pl-c1"},{"start":47,"end":51,"cssClass":"pl-en"}],[{"start":4,"end":8,"cssClass":"pl-k"}],[{"start":8,"end":13,"cssClass":"pl-k"}],[],[{"start":4,"end":129,"cssClass":"pl-c"}],[{"start":4,"end":16,"cssClass":"pl-s1"},{"start":17,"end":18,"cssClass":"pl-c1"},{"start":19,"end":29,"cssClass":"pl-s1"},{"start":30,"end":37,"cssClass":"pl-en"},{"start":38,"end":47,"cssClass":"pl-s"}],[{"start":4,"end":13,"cssClass":"pl-s1"},{"start":14,"end":15,"cssClass":"pl-c1"},{"start":17,"end":23,"cssClass":"pl-s"},{"start":25,"end":37,"cssClass":"pl-s1"},{"start":42,"end":124,"cssClass":"pl-c"}],[],[{"start":4,"end":24,"cssClass":"pl-c"}],[{"start":4,"end":12,"cssClass":"pl-s1"},{"start":13,"end":14,"cssClass":"pl-c1"},{"start":15,"end":23,"cssClass":"pl-s1"},{"start":24,"end":28,"cssClass":"pl-en"},{"start":29,"end":38,"cssClass":"pl-s1"},{"start":40,"end":44,"cssClass":"pl-s1"},{"start":45,"end":46,"cssClass":"pl-c1"},{"start":47,"end":56,"cssClass":"pl-s1"}],[],[{"start":4,"end":34,"cssClass":"pl-c"}],[{"start":4,"end":63,"cssClass":"pl-c"}],[{"start":4,"end":84,"cssClass":"pl-c"}],[],[{"start":4,"end":37,"cssClass":"pl-c"}],[{"start":4,"end":17,"cssClass":"pl-s1"},{"start":18,"end":19,"cssClass":"pl-c1"},{"start":20,"end":28,"cssClass":"pl-s1"},{"start":29,"end":33,"cssClass":"pl-en"}],[],[{"start":4,"end":65,"cssClass":"pl-c"}],[{"start":4,"end":17,"cssClass":"pl-s1"},{"start":18,"end":19,"cssClass":"pl-c1"},{"start":20,"end":22,"cssClass":"pl-s1"},{"start":23,"end":32,"cssClass":"pl-v"},{"start":33,"end":46,"cssClass":"pl-s1"},{"start":47,"end":55,"cssClass":"pl-s"}],[{"start":4,"end":135,"cssClass":"pl-c"}],[{"start":4,"end":17,"cssClass":"pl-s1"},{"start":18,"end":19,"cssClass":"pl-c1"},{"start":20,"end":33,"cssClass":"pl-s1"},{"start":34,"end":40,"cssClass":"pl-en"},{"start":42,"end":48,"cssClass":"pl-s"},{"start":49,"end":56,"cssClass":"pl-s"},{"start":58,"end":69,"cssClass":"pl-s"},{"start":70,"end":78,"cssClass":"pl-s"},{"start":81,"end":85,"cssClass":"pl-s1"},{"start":85,"end":86,"cssClass":"pl-c1"},{"start":86,"end":95,"cssClass":"pl-s"},{"start":98,"end":134,"cssClass":"pl-c"}],[{"start":4,"end":26,"cssClass":"pl-c"}],[],[{"start":4,"end":16,"cssClass":"pl-s1"},{"start":17,"end":18,"cssClass":"pl-c1"},{"start":19,"end":32,"cssClass":"pl-s1"},{"start":33,"end":40,"cssClass":"pl-en"},{"start":41,"end":47,"cssClass":"pl-s1"},{"start":47,"end":48,"cssClass":"pl-c1"},{"start":48,"end":57,"cssClass":"pl-s"}],[],[{"start":4,"end":35,"cssClass":"pl-c"}],[{"start":4,"end":12,"cssClass":"pl-s1"},{"start":13,"end":14,"cssClass":"pl-c1"},{"start":15,"end":23,"cssClass":"pl-s1"},{"start":24,"end":28,"cssClass":"pl-en"},{"start":29,"end":49,"cssClass":"pl-s1"},{"start":51,"end":55,"cssClass":"pl-s1"},{"start":55,"end":56,"cssClass":"pl-c1"},{"start":56,"end":68,"cssClass":"pl-s1"},{"start":70,"end":77,"cssClass":"pl-s1"},{"start":77,"end":78,"cssClass":"pl-c1"},{"start":78,"end":90,"cssClass":"pl-s1"}],[{"start":4,"end":42,"cssClass":"pl-c"}],[{"start":4,"end":9,"cssClass":"pl-en"},{"start":10,"end":72,"cssClass":"pl-s"},{"start":12,"end":37,"cssClass":"pl-s1"},{"start":12,"end":13,"cssClass":"pl-kos"},{"start":13,"end":21,"cssClass":"pl-s1"},{"start":22,"end":30,"cssClass":"pl-s1"},{"start":31,"end":34,"cssClass":"pl-en"},{"start":36,"end":37,"cssClass":"pl-kos"},{"start":39,"end":52,"cssClass":"pl-s1"},{"start":39,"end":40,"cssClass":"pl-kos"},{"start":40,"end":43,"cssClass":"pl-s1"},{"start":44,"end":48,"cssClass":"pl-s1"},{"start":49,"end":50,"cssClass":"pl-c1"},{"start":51,"end":52,"cssClass":"pl-kos"},{"start":62,"end":71,"cssClass":"pl-s1"},{"start":62,"end":63,"cssClass":"pl-kos"},{"start":63,"end":70,"cssClass":"pl-s1"},{"start":70,"end":71,"cssClass":"pl-kos"}],[{"start":4,"end":24,"cssClass":"pl-c"}],[],[{"start":4,"end":8,"cssClass":"pl-k"},{"start":9,"end":13,"cssClass":"pl-en"},{"start":14,"end":26,"cssClass":"pl-s1"},{"start":28,"end":31,"cssClass":"pl-s"},{"start":33,"end":35,"cssClass":"pl-k"},{"start":36,"end":37,"cssClass":"pl-s1"}],[{"start":8,"end":9,"cssClass":"pl-s1"},{"start":10,"end":15,"cssClass":"pl-en"},{"start":16,"end":23,"cssClass":"pl-s1"}],[],[{"start":0,"end":5,"cssClass":"pl-en"},{"start":6,"end":73,"cssClass":"pl-s"},{"start":8,"end":33,"cssClass":"pl-s1"},{"start":8,"end":9,"cssClass":"pl-kos"},{"start":9,"end":17,"cssClass":"pl-s1"},{"start":18,"end":26,"cssClass":"pl-s1"},{"start":27,"end":30,"cssClass":"pl-en"},{"start":32,"end":33,"cssClass":"pl-kos"},{"start":35,"end":48,"cssClass":"pl-s1"},{"start":35,"end":36,"cssClass":"pl-kos"},{"start":36,"end":39,"cssClass":"pl-s1"},{"start":40,"end":44,"cssClass":"pl-s1"},{"start":45,"end":46,"cssClass":"pl-c1"},{"start":47,"end":48,"cssClass":"pl-kos"},{"start":49,"end":51,"cssClass":"pl-cce"}]],"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":null,"configFilePath":null,"networkDependabotPath":"/davidcsisk/GPT_examples/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false,"repoAlertsPath":"/davidcsisk/GPT_examples/security/dependabot","repoSecurityAndAnalysisPath":"/davidcsisk/GPT_examples/settings/security_analysis","repoOwnerIsOrg":false,"currentUserCanAdminRepo":true},"displayName":"example_loading-data-from-mssql-into-solr-vector-embeddings.py","displayUrl":"https://github.com/davidcsisk/GPT_examples/blob/main/example_loading-data-from-mssql-into-solr-vector-embeddings.py?raw=true","headerInfo":{"blobSize":"4.5 KB","deleteInfo":{"deleteTooltip":"Delete this file"},"editInfo":{"editTooltip":"Edit this file"},"ghDesktopPath":"https://desktop.github.com","gitLfsPath":null,"onBranch":true,"shortPath":"77c960e","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2Fdavidcsisk%2FGPT_examples%2Fblob%2Fmain%2Fexample_loading-data-from-mssql-into-solr-vector-embeddings.py","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"104","truncatedSloc":"79"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplateHelpUrl":"https://docs.github.com/articles/about-issue-and-pull-request-templates","issueTemplate":null,"discussionTemplate":null,"language":"Python","languageID":303,"large":false,"loggedIn":true,"newDiscussionPath":"/davidcsisk/GPT_examples/discussions/new","newIssuePath":"/davidcsisk/GPT_examples/issues/new","planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/davidcsisk/GPT_examples/blob/main/example_loading-data-from-mssql-into-solr-vector-embeddings.py","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","dismissStackNoticePath":"/settings/dismiss-notice/publish_stack_from_file","releasePath":"/davidcsisk/GPT_examples/releases/new?marketplace=true","showPublishActionBanner":false,"showPublishStackBanner":false},"rawBlobUrl":"https://github.com/davidcsisk/GPT_examples/raw/main/example_loading-data-from-mssql-into-solr-vector-embeddings.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"repoOwner":"davidcsisk","repoName":"GPT_examples","showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","showDependabotConfigurationBanner":null,"actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timedOut":false,"notAnalyzed":false,"symbols":[{"name":"model_url","kind":"constant","identStart":1105,"identEnd":1114,"extentStart":1105,"extentEnd":1187,"fullyQualifiedName":"model_url","identUtf16":{"start":{"lineNumber":24,"utf16Col":0},"end":{"lineNumber":24,"utf16Col":9}},"extentUtf16":{"start":{"lineNumber":24,"utf16Col":0},"end":{"lineNumber":24,"utf16Col":82}}},{"name":"solr_url","kind":"constant","identStart":1285,"identEnd":1293,"extentStart":1285,"extentEnd":1360,"fullyQualifiedName":"solr_url","identUtf16":{"start":{"lineNumber":28,"utf16Col":0},"end":{"lineNumber":28,"utf16Col":8}},"extentUtf16":{"start":{"lineNumber":28,"utf16Col":0},"end":{"lineNumber":28,"utf16Col":75}}},{"name":"solr_headers","kind":"constant","identStart":1513,"identEnd":1525,"extentStart":1513,"extentEnd":1564,"fullyQualifiedName":"solr_headers","identUtf16":{"start":{"lineNumber":32,"utf16Col":0},"end":{"lineNumber":32,"utf16Col":12}},"extentUtf16":{"start":{"lineNumber":32,"utf16Col":0},"end":{"lineNumber":32,"utf16Col":51}}},{"name":"solr_url_with_commit","kind":"constant","identStart":1629,"identEnd":1649,"extentStart":1629,"extentEnd":1677,"fullyQualifiedName":"solr_url_with_commit","identUtf16":{"start":{"lineNumber":35,"utf16Col":0},"end":{"lineNumber":35,"utf16Col":20}},"extentUtf16":{"start":{"lineNumber":35,"utf16Col":0},"end":{"lineNumber":35,"utf16Col":48}}},{"name":"connfile","kind":"constant","identStart":1786,"identEnd":1794,"extentStart":1786,"extentEnd":1809,"fullyQualifiedName":"connfile","identUtf16":{"start":{"lineNumber":38,"utf16Col":0},"end":{"lineNumber":38,"utf16Col":8}},"extentUtf16":{"start":{"lineNumber":38,"utf16Col":0},"end":{"lineNumber":38,"utf16Col":23}}},{"name":"engine_mssql","kind":"constant","identStart":1863,"identEnd":1875,"extentStart":1863,"extentEnd":1978,"fullyQualifiedName":"engine_mssql","identUtf16":{"start":{"lineNumber":41,"utf16Col":0},"end":{"lineNumber":41,"utf16Col":12}},"extentUtf16":{"start":{"lineNumber":41,"utf16Col":0},"end":{"lineNumber":41,"utf16Col":115}}},{"name":"last_id_file","kind":"constant","identStart":2025,"identEnd":2037,"extentStart":2025,"extentEnd":2064,"fullyQualifiedName":"last_id_file","identUtf16":{"start":{"lineNumber":44,"utf16Col":0},"end":{"lineNumber":44,"utf16Col":12}},"extentUtf16":{"start":{"lineNumber":44,"utf16Col":0},"end":{"lineNumber":44,"utf16Col":39}}},{"name":"row_count","kind":"constant","identStart":2421,"identEnd":2430,"extentStart":2421,"extentEnd":2434,"fullyQualifiedName":"row_count","identUtf16":{"start":{"lineNumber":56,"utf16Col":0},"end":{"lineNumber":56,"utf16Col":9}},"extentUtf16":{"start":{"lineNumber":56,"utf16Col":0},"end":{"lineNumber":56,"utf16Col":13}}}]}},"copilotInfo":{"documentationUrl":"https://docs.github.com/copilot/overview-of-github-copilot/about-github-copilot-for-individuals","notices":{"codeViewPopover":{"dismissed":false,"dismissPath":"/settings/dismiss-notice/code_view_copilot_popover"}},"userAccess":{"accessAllowed":false,"hasSubscriptionEnded":false,"orgHasCFBAccess":false,"userHasCFIAccess":false,"userHasOrgs":false,"userIsOrgAdmin":false,"userIsOrgMember":false,"business":null,"featureRequestInfo":null}},"copilotAccessAllowed":false,"csrf_tokens":{"/davidcsisk/GPT_examples/branches":{"post":"vFMmGkF5asF1WZWva-SoPKyAM9OsN_i5hnlKTbT9Ix29_9_KqVmqtqyarrz3XIa9RigY09yz-HVLyj1Dm_p2AQ"},"/repos/preferences":{"post":"lC_MqBI_h211S1tNf1ib4VmJTwcxS1b5ZNO0RfL3Yl6HpILiNe70aN1Gbob0bXCHGcTXgAF0VY5Hx3ZsC-n69w"}}},"title":"GPT_examples/example_loading-data-from-mssql-into-solr-vector-embeddings.py at main · davidcsisk/GPT_examples","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-3722b59160bc.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-b812db9596b1.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"copilot_conversational_ux":false,"copilot_conversational_ux_embedding_update":false,"copilot_conversational_ux_streaming":true,"copilot_popover_file_editor_header":true,"copilot_smell_icebreaker_ux":false}}}</script>
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC24" class="react-file-line html-div" data-testid="code-cell" data-line-number="24" style="position:relative"><span class="pl-c"># URL for the vector embedding API call</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC25" class="react-file-line html-div" data-testid="code-cell" data-line-number="25" style="position:relative"><span class="pl-s1">model_url</span> <span class="pl-c1">=</span> <span class="pl-s">&#039;http://52.151.224.249:80/api/v1/service/futuresearch-embedding/score&#039;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC26" class="react-file-line html-div" data-testid="code-cell" data-line-number="26" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC27" class="react-file-line html-div" data-testid="code-cell" data-line-number="27" style="position:relative"><span class="pl-c"># Solr POST url</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC28" class="react-file-line html-div" data-testid="code-cell" data-line-number="28" style="position:relative"><span class="pl-c">#solr_url = &#039;http://mrksolr1.bos.bullhorn.com:8983/solr/sisk-test-1/update&#039;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC29" class="react-file-line html-div" data-testid="code-cell" data-line-number="29" style="position:relative"><span class="pl-s1">solr_url</span> <span class="pl-c1">=</span> <span class="pl-s">&#039;http://mrksolr1.bos.bullhorn.com:8983/solr/soliant-jobs/update&#039;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC30" class="react-file-line html-div" data-testid="code-cell" data-line-number="30" style="position:relative"><span class="pl-c">#solr_url = &#039;http://devsolr1.dev.bullhorn.com:8983/solr/sisk-test-collection/update&#039;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC31" class="react-file-line html-div" data-testid="code-cell" data-line-number="31" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC32" class="react-file-line html-div" data-testid="code-cell" data-line-number="32" style="position:relative"><span class="pl-c"># For posting documents to Solr, set the content type to JSON</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC33" class="react-file-line html-div" data-testid="code-cell" data-line-number="33" style="position:relative"><span class="pl-s1">solr_headers</span> <span class="pl-c1">=</span> {<span class="pl-s">&#039;Content-type&#039;</span>: <span class="pl-s">&#039;application/json&#039;</span>}</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC34" class="react-file-line html-div" data-testid="code-cell" data-line-number="34" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC35" class="react-file-line html-div" data-testid="code-cell" data-line-number="35" style="position:relative"><span class="pl-c"># Add the commit parameter to the URL to enable auto-commit</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC36" class="react-file-line html-div" data-testid="code-cell" data-line-number="36" style="position:relative"><span class="pl-s1">solr_url_with_commit</span> <span class="pl-c1">=</span> <span class="pl-s">f&#039;<span class="pl-s1"><span class="pl-kos">{</span><span class="pl-s1">solr_url</span><span class="pl-kos">}</span></span>?commit=true&#039;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC37" class="react-file-line html-div" data-testid="code-cell" data-line-number="37" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC38" class="react-file-line html-div" data-testid="code-cell" data-line-number="38" style="position:relative"><span class="pl-c"># Read the connection info from a conn file in the script directory, and open a connection to SQLServer</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC39" class="react-file-line html-div" data-testid="code-cell" data-line-number="39" style="position:relative"><span class="pl-s1">connfile</span> <span class="pl-c1">=</span> <span class="pl-s">&#039;mssql.conn&#039;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC40" class="react-file-line html-div" data-testid="code-cell" data-line-number="40" style="position:relative"><span class="pl-k">with</span> <span class="pl-en">open</span>(<span class="pl-s1">connfile</span>) <span class="pl-k">as</span> <span class="pl-s1">f</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC41" class="react-file-line html-div" data-testid="code-cell" data-line-number="41" style="position:relative">    <span class="pl-s1">conninfo</span> <span class="pl-c1">=</span> <span class="pl-s1">f</span>.<span class="pl-en">read</span>()</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC42" class="react-file-line html-div" data-testid="code-cell" data-line-number="42" style="position:relative"><span class="pl-s1">engine_mssql</span> <span class="pl-c1">=</span> <span class="pl-en">create_engine</span>(<span class="pl-s1">conninfo</span>, <span class="pl-s1">encoding</span><span class="pl-c1">=</span><span class="pl-s">&#039;utf16&#039;</span>, <span class="pl-s1">execution_options</span><span class="pl-c1">=</span>{<span class="pl-s">&quot;isolation_level&quot;</span>: <span class="pl-s">&quot;READ UNCOMMITTED&quot;</span>})</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC43" class="react-file-line html-div" data-testid="code-cell" data-line-number="43" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC44" class="react-file-line html-div" data-testid="code-cell" data-line-number="44" style="position:relative"><span class="pl-c"># File that tracks last ID loaded to Solr</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC45" class="react-file-line html-div" data-testid="code-cell" data-line-number="45" style="position:relative"><span class="pl-s1">last_id_file</span> <span class="pl-c1">=</span> <span class="pl-s">&#039;state-jobs-last-id.cfg&#039;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC46" class="react-file-line html-div" data-testid="code-cell" data-line-number="46" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC47" class="react-file-line html-div" data-testid="code-cell" data-line-number="47" style="position:relative"><span class="pl-c"># Check that the lastID file already exists...if not, create it and set the lastID to 0 </span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC48" class="react-file-line html-div" data-testid="code-cell" data-line-number="48" style="position:relative"><span class="pl-k">if</span> <span class="pl-s1">os</span>.<span class="pl-s1">path</span>.<span class="pl-en">exists</span>(<span class="pl-s1">last_id_file</span>) <span class="pl-c1">==</span> <span class="pl-c1">False</span>: </div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC49" class="react-file-line html-div" data-testid="code-cell" data-line-number="49" style="position:relative">    <span class="pl-k">with</span> <span class="pl-en">open</span>(<span class="pl-s1">last_id_file</span>, <span class="pl-s">&#039;w&#039;</span>) <span class="pl-k">as</span> <span class="pl-s1">f</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC50" class="react-file-line html-div" data-testid="code-cell" data-line-number="50" style="position:relative">        <span class="pl-s1">f</span>.<span class="pl-en">write</span>(<span class="pl-s">&#039;0&#039;</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC51" class="react-file-line html-div" data-testid="code-cell" data-line-number="51" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC52" class="react-file-line html-div" data-testid="code-cell" data-line-number="52" style="position:relative"><span class="pl-k">with</span> <span class="pl-en">open</span>(<span class="pl-s1">last_id_file</span>) <span class="pl-k">as</span> <span class="pl-s1">f</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC53" class="react-file-line html-div" data-testid="code-cell" data-line-number="53" style="position:relative">    <span class="pl-s1">last_id</span> <span class="pl-c1">=</span> <span class="pl-s1">f</span>.<span class="pl-en">read</span>()</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC54" class="react-file-line html-div" data-testid="code-cell" data-line-number="54" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC55" class="react-file-line html-div" data-testid="code-cell" data-line-number="55" style="position:relative"><span class="pl-en">print</span>(<span class="pl-s">f&quot;<span class="pl-s1"><span class="pl-kos">{</span><span class="pl-s1">datetime</span>.<span class="pl-s1">datetime</span>.<span class="pl-en">now</span>()<span class="pl-kos">}</span></span>: <span class="pl-s1"><span class="pl-kos">{</span><span class="pl-s1">sys</span>.<span class="pl-s1">argv</span>[<span class="pl-c1">0</span>]<span class="pl-kos">}</span></span> Starting executing with lastID <span class="pl-s1"><span class="pl-kos">{</span><span class="pl-s1">last_id</span><span class="pl-kos">}</span></span>...&quot;</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC56" class="react-file-line html-div" data-testid="code-cell" data-line-number="56" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC57" class="react-file-line html-div" data-testid="code-cell" data-line-number="57" style="position:relative"><span class="pl-s1">row_count</span> <span class="pl-c1">=</span> <span class="pl-c1">1</span> <span class="pl-c"># Set this to an artificial value to get into the first pass of the loop</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC58" class="react-file-line html-div" data-testid="code-cell" data-line-number="58" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC59" class="react-file-line html-div" data-testid="code-cell" data-line-number="59" style="position:relative"><span class="pl-k">while</span> <span class="pl-s1">row_count</span> <span class="pl-c1">&gt;</span> <span class="pl-c1">0</span>: </div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC60" class="react-file-line html-div" data-testid="code-cell" data-line-number="60" style="position:relative">    <span class="pl-c"># Get the last known last ID processed</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC61" class="react-file-line html-div" data-testid="code-cell" data-line-number="61" style="position:relative">    <span class="pl-k">with</span> <span class="pl-en">open</span>(<span class="pl-s1">last_id_file</span>) <span class="pl-k">as</span> <span class="pl-s1">f</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC62" class="react-file-line html-div" data-testid="code-cell" data-line-number="62" style="position:relative">        <span class="pl-s1">last_id</span> <span class="pl-c1">=</span> <span class="pl-s1">f</span>.<span class="pl-en">read</span>()</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC63" class="react-file-line html-div" data-testid="code-cell" data-line-number="63" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC64" class="react-file-line html-div" data-testid="code-cell" data-line-number="64" style="position:relative">    <span class="pl-s1">job_query_sql</span> <span class="pl-c1">=</span> <span class="pl-s">&#039;select top 500 jobPostingID id, title text from bullhorn1.BH_JobOpportunity <span class="pl-cce">\</span></span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC65" class="react-file-line html-div" data-testid="code-cell" data-line-number="65" style="position:relative"><span class="pl-s">                     where title is not null and jobPostingID &gt; &#039;</span> <span class="pl-c1">+</span> <span class="pl-s1">last_id</span> <span class="pl-c1">+</span> <span class="pl-s">&#039;order by 1;&#039;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC66" class="react-file-line html-div" data-testid="code-cell" data-line-number="66" style="position:relative">    <span class="pl-s1">df_jobdata</span> <span class="pl-c1">=</span> <span class="pl-s1">pd</span>.<span class="pl-en">read_sql</span>(<span class="pl-s1">job_query_sql</span>, <span class="pl-s1">engine_mssql</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC67" class="react-file-line html-div" data-testid="code-cell" data-line-number="67" style="position:relative">    <span class="pl-s1">row_count</span> <span class="pl-c1">=</span> <span class="pl-s1">df_jobdata</span>.<span class="pl-s1">shape</span>[<span class="pl-c1">0</span>]</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC68" class="react-file-line html-div" data-testid="code-cell" data-line-number="68" style="position:relative">    <span class="pl-k">if</span> <span class="pl-s1">row_count</span> <span class="pl-c1">&gt;</span> <span class="pl-c1">0</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC69" class="react-file-line html-div" data-testid="code-cell" data-line-number="69" style="position:relative">        <span class="pl-s1">last_id</span> <span class="pl-c1">=</span> <span class="pl-en">str</span>(<span class="pl-s1">df_jobdata</span>[<span class="pl-s">&#039;id&#039;</span>].<span class="pl-en">tail</span>(<span class="pl-c1">1</span>).<span class="pl-en">item</span>())</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC70" class="react-file-line html-div" data-testid="code-cell" data-line-number="70" style="position:relative">    <span class="pl-k">else</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC71" class="react-file-line html-div" data-testid="code-cell" data-line-number="71" style="position:relative">        <span class="pl-k">break</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC72" class="react-file-line html-div" data-testid="code-cell" data-line-number="72" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC73" class="react-file-line html-div" data-testid="code-cell" data-line-number="73" style="position:relative">    <span class="pl-c"># Output the batch of rows to a dictionary, then wrap the dict in another dict to get the right JSON format for the API call</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC74" class="react-file-line html-div" data-testid="code-cell" data-line-number="74" style="position:relative">    <span class="pl-s1">dict_jobdata</span> <span class="pl-c1">=</span> <span class="pl-s1">df_jobdata</span>.<span class="pl-en">to_dict</span>(<span class="pl-s">&#039;records&#039;</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC75" class="react-file-line html-div" data-testid="code-cell" data-line-number="75" style="position:relative">    <span class="pl-s1">inputdata</span> <span class="pl-c1">=</span> {<span class="pl-s">&#039;data&#039;</span>: <span class="pl-s1">dict_jobdata</span> }   <span class="pl-c"># Nest the DF inside another JSON document so it looks like our sample input data</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC76" class="react-file-line html-div" data-testid="code-cell" data-line-number="76" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC77" class="react-file-line html-div" data-testid="code-cell" data-line-number="77" style="position:relative">    <span class="pl-c"># Make the API call</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC78" class="react-file-line html-div" data-testid="code-cell" data-line-number="78" style="position:relative">    <span class="pl-s1">response</span> <span class="pl-c1">=</span> <span class="pl-s1">requests</span>.<span class="pl-en">post</span>(<span class="pl-s1">model_url</span>, <span class="pl-s1">json</span> <span class="pl-c1">=</span> <span class="pl-s1">inputdata</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC79" class="react-file-line html-div" data-testid="code-cell" data-line-number="79" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC80" class="react-file-line html-div" data-testid="code-cell" data-line-number="80" style="position:relative">    <span class="pl-c"># Check if the call succeeded</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC81" class="react-file-line html-div" data-testid="code-cell" data-line-number="81" style="position:relative">    <span class="pl-c">#print(&#039;RESPONSE: &#039;, response.status_code) # Should be 200</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC82" class="react-file-line html-div" data-testid="code-cell" data-line-number="82" style="position:relative">    <span class="pl-c">#print(json.dumps(response.json(), indent=2))  # Print readable structured json</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC83" class="react-file-line html-div" data-testid="code-cell" data-line-number="83" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC84" class="react-file-line html-div" data-testid="code-cell" data-line-number="84" style="position:relative">    <span class="pl-c"># Put the json into a dictionary</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC85" class="react-file-line html-div" data-testid="code-cell" data-line-number="85" style="position:relative">    <span class="pl-s1">response_dict</span> <span class="pl-c1">=</span> <span class="pl-s1">response</span>.<span class="pl-en">json</span>()</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC86" class="react-file-line html-div" data-testid="code-cell" data-line-number="86" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC87" class="react-file-line html-div" data-testid="code-cell" data-line-number="87" style="position:relative">    <span class="pl-c"># Make a dataframe from the output section of the dictionary</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC88" class="react-file-line html-div" data-testid="code-cell" data-line-number="88" style="position:relative">    <span class="pl-s1">df_jobvectors</span> <span class="pl-c1">=</span> <span class="pl-s1">pd</span>.<span class="pl-v">DataFrame</span>(<span class="pl-s1">response_dict</span>[<span class="pl-s">&#039;output&#039;</span>])</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC89" class="react-file-line html-div" data-testid="code-cell" data-line-number="89" style="position:relative">    <span class="pl-c"># Set column names to &quot;title&quot; and &quot;vector&quot;...we&#039;ve already created a vector field with 32 dimensions and datatype DenseVectorField</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC90" class="react-file-line html-div" data-testid="code-cell" data-line-number="90" style="position:relative">    <span class="pl-s1">df_jobvectors</span> <span class="pl-c1">=</span> <span class="pl-s1">df_jobvectors</span>.<span class="pl-en">rename</span>({<span class="pl-s">&#039;text&#039;</span>:<span class="pl-s">&#039;title&#039;</span>, <span class="pl-s">&#039;embedding&#039;</span>:<span class="pl-s">&#039;vector&#039;</span>}, <span class="pl-s1">axis</span><span class="pl-c1">=</span><span class="pl-s">&#039;columns&#039;</span>)  <span class="pl-c"># Should now have id, title, vector</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC91" class="react-file-line html-div" data-testid="code-cell" data-line-number="91" style="position:relative">    <span class="pl-c">#print(df_jobvectors)</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC92" class="react-file-line html-div" data-testid="code-cell" data-line-number="92" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC93" class="react-file-line html-div" data-testid="code-cell" data-line-number="93" style="position:relative">    <span class="pl-s1">data_payload</span> <span class="pl-c1">=</span> <span class="pl-s1">df_jobvectors</span>.<span class="pl-en">to_json</span>(<span class="pl-s1">orient</span><span class="pl-c1">=</span><span class="pl-s">&#039;records&#039;</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC94" class="react-file-line html-div" data-testid="code-cell" data-line-number="94" style="position:relative">    </div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC95" class="react-file-line html-div" data-testid="code-cell" data-line-number="95" style="position:relative">    <span class="pl-c">#print(&quot;Sent: &quot;, data_payload)</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC96" class="react-file-line html-div" data-testid="code-cell" data-line-number="96" style="position:relative">    <span class="pl-s1">add_docs</span> <span class="pl-c1">=</span> <span class="pl-s1">requests</span>.<span class="pl-en">post</span>(<span class="pl-s1">solr_url_with_commit</span>, <span class="pl-s1">data</span><span class="pl-c1">=</span><span class="pl-s1">data_payload</span>, <span class="pl-s1">headers</span><span class="pl-c1">=</span><span class="pl-s1">solr_headers</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC97" class="react-file-line html-div" data-testid="code-cell" data-line-number="97" style="position:relative">    <span class="pl-c">#print(&quot;Response: &quot;, add_docs.json())</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC98" class="react-file-line html-div" data-testid="code-cell" data-line-number="98" style="position:relative">    <span class="pl-en">print</span>(<span class="pl-s">f&quot;<span class="pl-s1"><span class="pl-kos">{</span><span class="pl-s1">datetime</span>.<span class="pl-s1">datetime</span>.<span class="pl-en">now</span>()<span class="pl-kos">}</span></span>: <span class="pl-s1"><span class="pl-kos">{</span><span class="pl-s1">sys</span>.<span class="pl-s1">argv</span>[<span class="pl-c1">0</span>]<span class="pl-kos">}</span></span> Last ID: <span class="pl-s1"><span class="pl-kos">{</span><span class="pl-s1">last_id</span><span class="pl-kos">}</span></span>&quot;</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC99" class="react-file-line html-div" data-testid="code-cell" data-line-number="99" style="position:relative">    <span class="pl-c">#print(&quot;.&quot;, end=&quot;&quot;)</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC100" class="react-file-line html-div" data-testid="code-cell" data-line-number="100" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC101" class="react-file-line html-div" data-testid="code-cell" data-line-number="101" style="position:relative">    <span class="pl-k">with</span> <span class="pl-en">open</span>(<span class="pl-s1">last_id_file</span>, <span class="pl-s">&#039;w&#039;</span>) <span class="pl-k">as</span> <span class="pl-s1">f</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC102" class="react-file-line html-div" data-testid="code-cell" data-line-number="102" style="position:relative">        <span class="pl-s1">f</span>.<span class="pl-en">write</span>(<span class="pl-s1">last_id</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC103" class="react-file-line html-div" data-testid="code-cell" data-line-number="103" style="position:relative">    </div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC104" class="react-file-line html-div" data-testid="code-cell" data-line-number="104" style="position:relative"><span class="pl-en">print</span>(<span class="pl-s">f&quot;<span class="pl-s1"><span class="pl-kos">{</span><span class="pl-s1">datetime</span>.<span class="pl-s1">datetime</span>.<span class="pl-en">now</span>()<span class="pl-kos">}</span></span>: <span class="pl-s1"><span class="pl-kos">{</span><span class="pl-s1">sys</span>.<span class="pl-s1">argv</span>[<span class="pl-c1">0</span>]<span class="pl-kos">}</span></span> <span class="pl-cce">\n</span>Finished executing...&quot;</span>)</div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div><div class="Box-sc-g0xbh4-0 ktQnIo"></div><div class="Box-sc-g0xbh4-0 bgHcBP panel-content-narrow-styles inner-panel-content-not-narrow"><div id="symbols-pane" class="Box-sc-g0xbh4-0"><div aria-labelledby="symbols-pane-header" class="Box-sc-g0xbh4-0 bJNAmt"><div class="Box-sc-g0xbh4-0 ipXucK"><h2 id="symbols-pane-header" tabindex="-1" class="Box-sc-g0xbh4-0 wMEyi">Symbols</h2><button data-component="IconButton" type="button" aria-label="Close symbols" data-hotkey="Escape" data-no-visuals="true" class="types__StyledButton-sc-ws60qy-0 iuWWMB"><svg aria-hidden="true" focusable="false" role="img" class="octicon octicon-x" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path></svg></button></div><div class="Box-sc-g0xbh4-0 igdeeu">Find definitions and references for functions and other symbols in this file by clicking a symbol below or in the code.</div><span class="TextInputWrapper__TextInputBaseWrapper-sc-1mqhpbi-0 TextInputWrapper-sc-1mqhpbi-1 hdWBGU kdlhpP TextInput-wrapper" aria-busy="false"><span class="TextInput-icon"><svg aria-hidden="true" focusable="false" role="img" class="Octicon-sc-9kayk9-0" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M.75 3h14.5a.75.75 0 0 1 0 1.5H.75a.75.75 0 0 1 0-1.5ZM3 7.75A.75.75 0 0 1 3.75 7h8.5a.75.75 0 0 1 0 1.5h-8.5A.75.75 0 0 1 3 7.75Zm3 4a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg></span><input type="text" placeholder="Filter symbols" name="Filter symbols" aria-label="Filter symbols" aria-controls="filter-results" aria-expanded="true" aria-autocomplete="list" role="combobox" data-component="input" class="UnstyledTextInput-sc-14ypya-0 cDLBls" value=""/><span class="TextInput-icon"><div class="Box-sc-g0xbh4-0 ckwgci"><kbd>r</kbd></div></span></span><div class="Box-sc-g0xbh4-0 jGYebd"><div class="Box-sc-g0xbh4-0 kgNotW"><span role="status" aria-live="polite" aria-atomic="true" class="_VisuallyHidden__VisuallyHidden-sc-11jhm7a-0 rTZSs"></span><ul role="tree" aria-label="Code Navigation" data-omit-spacer="true" class="TreeView__UlBox-sc-4ex6b6-0 gtekST"><li class="PRIVATE_TreeView-item" tabindex="0" id="0model_url" role="treeitem" aria-labelledby=":R6hlqlajal5:" aria-describedby=":R6hlqlajal5H1: :R6hlqlajal5H2:" aria-level="1" aria-selected="false"><div class="PRIVATE_TreeView-item-container" style="--level:1"><div style="grid-area:spacer;display:flex"><div style="width:100%;display:flex"></div></div><div id=":R6hlqlajal5:" class="PRIVATE_TreeView-item-content"><span class="PRIVATE_TreeView-item-content-text"><div class="Box-sc-g0xbh4-0 cFPoqW"><div class="Box-sc-g0xbh4-0 brdoto"><div class="Box-sc-g0xbh4-0 fQgtqx"></div><div class="Box-sc-g0xbh4-0 EVPPH">const</div></div>  <div title="model_url" class="Truncate__StyledTruncate-sc-23o1d2-0 iQHhGT"><span class="Text-sc-17v1xeu-0 gPDEWA">model_url</span></div></div></span></div></div></li><li class="PRIVATE_TreeView-item" tabindex="0" id="1solr_url" role="treeitem" aria-labelledby=":Rahlqlajal5:" aria-describedby=":Rahlqlajal5H1: :Rahlqlajal5H2:" aria-level="1" aria-selected="false"><div class="PRIVATE_TreeView-item-container" style="--level:1"><div style="grid-area:spacer;display:flex"><div style="width:100%;display:flex"></div></div><div id=":Rahlqlajal5:" class="PRIVATE_TreeView-item-content"><span class="PRIVATE_TreeView-item-content-text"><div class="Box-sc-g0xbh4-0 cFPoqW"><div class="Box-sc-g0xbh4-0 brdoto"><div class="Box-sc-g0xbh4-0 fQgtqx"></div><div class="Box-sc-g0xbh4-0 EVPPH">const</div></div>  <div title="solr_url" class="Truncate__StyledTruncate-sc-23o1d2-0 iQHhGT"><span class="Text-sc-17v1xeu-0 gPDEWA">solr_url</span></div></div></span></div></div></li><li class="PRIVATE_TreeView-item" tabindex="0" id="2solr_headers" role="treeitem" aria-labelledby=":Rehlqlajal5:" aria-describedby=":Rehlqlajal5H1: :Rehlqlajal5H2:" aria-level="1" aria-selected="false"><div class="PRIVATE_TreeView-item-container" style="--level:1"><div style="grid-area:spacer;display:flex"><div style="width:100%;display:flex"></div></div><div id=":Rehlqlajal5:" class="PRIVATE_TreeView-item-content"><span class="PRIVATE_TreeView-item-content-text"><div class="Box-sc-g0xbh4-0 cFPoqW"><div class="Box-sc-g0xbh4-0 brdoto"><div class="Box-sc-g0xbh4-0 fQgtqx"></div><div class="Box-sc-g0xbh4-0 EVPPH">const</div></div>  <div title="solr_headers" class="Truncate__StyledTruncate-sc-23o1d2-0 iQHhGT"><span class="Text-sc-17v1xeu-0 gPDEWA">solr_headers</span></div></div></span></div></div></li><li class="PRIVATE_TreeView-item" tabindex="0" id="3solr_url_with_commit" role="treeitem" aria-labelledby=":Rihlqlajal5:" aria-describedby=":Rihlqlajal5H1: :Rihlqlajal5H2:" aria-level="1" aria-selected="false"><div class="PRIVATE_TreeView-item-container" style="--level:1"><div style="grid-area:spacer;display:flex"><div style="width:100%;display:flex"></div></div><div id=":Rihlqlajal5:" class="PRIVATE_TreeView-item-content"><span class="PRIVATE_TreeView-item-content-text"><div class="Box-sc-g0xbh4-0 cFPoqW"><div class="Box-sc-g0xbh4-0 brdoto"><div class="Box-sc-g0xbh4-0 fQgtqx"></div><div class="Box-sc-g0xbh4-0 EVPPH">const</div></div>  <div title="solr_url_with_commit" class="Truncate__StyledTruncate-sc-23o1d2-0 iQHhGT"><span class="Text-sc-17v1xeu-0 gPDEWA">solr_url_with_commit</span></div></div></span></div></div></li><li class="PRIVATE_TreeView-item" tabindex="0" id="4connfile" role="treeitem" aria-labelledby=":Rmhlqlajal5:" aria-describedby=":Rmhlqlajal5H1: :Rmhlqlajal5H2:" aria-level="1" aria-selected="false"><div class="PRIVATE_TreeView-item-container" style="--level:1"><div style="grid-area:spacer;display:flex"><div style="width:100%;display:flex"></div></div><div id=":Rmhlqlajal5:" class="PRIVATE_TreeView-item-content"><span class="PRIVATE_TreeView-item-content-text"><div class="Box-sc-g0xbh4-0 cFPoqW"><div class="Box-sc-g0xbh4-0 brdoto"><div class="Box-sc-g0xbh4-0 fQgtqx"></div><div class="Box-sc-g0xbh4-0 EVPPH">const</div></div>  <div title="connfile" class="Truncate__StyledTruncate-sc-23o1d2-0 iQHhGT"><span class="Text-sc-17v1xeu-0 gPDEWA">connfile</span></div></div></span></div></div></li><li class="PRIVATE_TreeView-item" tabindex="0" id="5engine_mssql" role="treeitem" aria-labelledby=":Rqhlqlajal5:" aria-describedby=":Rqhlqlajal5H1: :Rqhlqlajal5H2:" aria-level="1" aria-selected="false"><div class="PRIVATE_TreeView-item-container" style="--level:1"><div style="grid-area:spacer;display:flex"><div style="width:100%;display:flex"></div></div><div id=":Rqhlqlajal5:" class="PRIVATE_TreeView-item-content"><span class="PRIVATE_TreeView-item-content-text"><div class="Box-sc-g0xbh4-0 cFPoqW"><div class="Box-sc-g0xbh4-0 brdoto"><div class="Box-sc-g0xbh4-0 fQgtqx"></div><div class="Box-sc-g0xbh4-0 EVPPH">const</div></div>  <div title="engine_mssql" class="Truncate__StyledTruncate-sc-23o1d2-0 iQHhGT"><span class="Text-sc-17v1xeu-0 gPDEWA">engine_mssql</span></div></div></span></div></div></li><li class="PRIVATE_TreeView-item" tabindex="0" id="6last_id_file" role="treeitem" aria-labelledby=":Ruhlqlajal5:" aria-describedby=":Ruhlqlajal5H1: :Ruhlqlajal5H2:" aria-level="1" aria-selected="false"><div class="PRIVATE_TreeView-item-container" style="--level:1"><div style="grid-area:spacer;display:flex"><div style="width:100%;display:flex"></div></div><div id=":Ruhlqlajal5:" class="PRIVATE_TreeView-item-content"><span class="PRIVATE_TreeView-item-content-text"><div class="Box-sc-g0xbh4-0 cFPoqW"><div class="Box-sc-g0xbh4-0 brdoto"><div class="Box-sc-g0xbh4-0 fQgtqx"></div><div class="Box-sc-g0xbh4-0 EVPPH">const</div></div>  <div title="last_id_file" class="Truncate__StyledTruncate-sc-23o1d2-0 iQHhGT"><span class="Text-sc-17v1xeu-0 gPDEWA">last_id_file</span></div></div></span></div></div></li><li class="PRIVATE_TreeView-item" tabindex="0" id="7row_count" role="treeitem" aria-labelledby=":R12hlqlajal5:" aria-describedby=":R12hlqlajal5H1: :R12hlqlajal5H2:" aria-level="1" aria-selected="false"><div class="PRIVATE_TreeView-item-container" style="--level:1"><div style="grid-area:spacer;display:flex"><div style="width:100%;display:flex"></div></div><div id=":R12hlqlajal5:" class="PRIVATE_TreeView-item-content"><span class="PRIVATE_TreeView-item-content-text"><div class="Box-sc-g0xbh4-0 cFPoqW"><div class="Box-sc-g0xbh4-0 brdoto"><div class="Box-sc-g0xbh4-0 fQgtqx"></div><div class="Box-sc-g0xbh4-0 EVPPH">const</div></div>  <div title="row_count" class="Truncate__StyledTruncate-sc-23o1d2-0 iQHhGT"><span class="Text-sc-17v1xeu-0 gPDEWA">row_count</span></div></div></span></div></div></li></ul></div></div></div></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></main></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 aZrVR"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
